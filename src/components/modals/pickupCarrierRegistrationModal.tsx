...
const PickupCarrierRegistrationModal = ({
  ...
  const handleFileChange = (event: any, setFile: any) => {
    ...
    if (file && file.type === "application/pdf") {
      ...
      console.log('hereessa')
      setFile(file);
    } else {
      console.log('>>><<<')
      setFieldError("Please select a PDF file under 5 MB.");
    }
      ...
      if (movingCompanyOfficialLicense.type !== "application/pdf"){
        ...
        if(movingCompanyOfficialLicense.size > 5000000)  {
          ...
          if (ownerDriverLicense.type !== "application/pdf") {
            setFieldError("Please select a PDF file for Owner Drivers License document.");
          } else {
                  ...
                  if (!validateEmail(ownerEmail)) {
                    ...
                    if (ownerPhoneNumber.length !== 10) {
                      ...
                      if(w9Form.type !== 'application/pdf'){
                        setFieldError("Please select a PDF file for W9 Form document");
                      }else{
                        if(w9Form.size > 5000000){
         setFieldError("Please select W9 Form PDF file under 5 MB.");
                        }else{
                          checkIfAccountExists();
                          // setStep(3);
                        }
      ...
      if (trucksInOperation === null || trucksInOperation < 0) {
        ...
        if (yearsInBusiness === null || yearsInBusiness < 0) {
          ...
          if (insuranceCompanyName === "") {
            ...
            setFieldError("Please select a PDF file for Insurance document.");
                }else{
                  if(insuranceDocument.size > 5000000){
         setFieldError("Please select Insurance document PDF file under 5 MB.");
                  }else{
                    setStep(4);
                  }
                }
  ...
  const createPickupRegisterCarrier = () => {
    ...
    const body = {
      ...
      doing_business_as_name: doingBusinessAsName!==""?doingBusinessAsName : companyName,
  ...
  return (
    <>
      <Modal
        open={pickupCarrierRegistrationModalVisible}
        onClose={handleClose}
        ...
        >
          ...
          >
            {infoLostAlertModalVisible && (
              <InfoLostAlertModal
                ...
                setAnyModal={setPickupCarrierRegistrationModalVisible}
              />
            )}
          ...
          {isVerifyOtpModal && (
            <VerifyOtpModal
              ...
              setParentModal={setPickupCarrierRegistrationModalVisible}
            />
          )}
          {success && (
          ...
          {step === 2 && (
            <>
              ...
              <Typography color={'#FF0000'} fontWeight={500} fontSize={14}>
                  If your files are larger than 5 MB please contact us at carrier@wemove.ai
                </Typography>
                <Typography fontWeight={600} fontSize={16}>
                  Upload Company Tariff Document in PDF format. (5 MB maximum file size)
                </Typography>
                ...
                <Typography mt={2} fontWeight={600} fontSize={16}>
                  Upload Owner Drivers License Document in PDF format. (5 MB maximum file size)
                </Typography>
                ...
                <Typography mt={2} fontWeight={600} fontSize={16}>
                  Upload W9 Form Document in PDF format. (5 MB maximum file size)
                </Typography>
                ...
                <Box mt={3} display={"flex"} justifyContent={"end"}>
                  <Button
                    ...
                    onClick={() => {
                      ...
                      // console.log(ownerName+' '+ownerLastName)
                    }}
                  >
                    Next →
                  </Button>
          ...
          {step === 3 && (
            <>
              ...
              <Box component="form" p={3}>
                ...
                <Typography mt={2} color={'#FF0000'} fontWeight={500} fontSize={14}>
                  If your file is larger than 5 MB please contact us at carrier@wemove.ai
                </Typography>
                <Typography  fontWeight={600} fontSize={16}>
                  Upload Proof of Insurance Document in PDF format. (5 MB maximum file size. )
                </Typography>
...
export default PickupCarrierRegistrationModal;
