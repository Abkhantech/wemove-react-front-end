...
import { activatePickupCarrier } from "../../redux/actions/pickup-carrier";
import { useState } from "react";
import CloseIcon from "@mui/icons-material/Close";

const PickupCarrierTable = ({ pickupCarriers, getPickupCarriers }: any) => {
  ...
  const handlePickupCarrierActivation = (id: any, activation_status: any) => {
    setIsLoading(true);
    const body = {
      id: id,
    ...
    dispatch<any>(activatePickupCarrier(body))
      .then(unwrapResult)
      .then((res: any) => {
        console.log("res", res);
        getPickupCarriers();
      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 650 }}>
          ...
          {pickupCarriers.length !== 0 ?
              pickupCarriers.map((carrier: any) => (
                <TableRow
                  key={carrier.id}
                    ...
                    {carrier.activation_status ? (
                      <Stack>
                        ...
                        <Button
                          ...
                          disabled={isLoading}
                          onClick={() => {
                            handlePickupCarrierActivation(carrier.id, false);
                          }}
                        >
                          Deactivate
                        </Button>
                      ...
                      <Stack>
                        ...
                        <Button
                          ...
                          disabled={isLoading}
                          onClick={() => {
                            handlePickupCarrierActivation(carrier.id, true);
                          }}
                        >
                          Activate
                        </Button>
...
export default PickupCarrierTable;
